...
generator(100, {
  ...
  describe('Weight Test', () => {
    ...
    resources.forEach(function(o) {
      it('creates weight resource', function(done) {
          request
            .post('/api/v1/weight')
    ...
    resources.forEach(function(o) {
      it('fails to create an existing weight resource', function(done) {
          request
            .post('/api/v1/weight')
            .set('Authorization', `Bearer ${token}`)
            .send(o)
    ...
    resources.forEach(function(o, i){
      it('checks created weight resource', function(done) {
          request
            .get(`/api/v1/weight/${createdIds[i]}`)
            .set('Authorization', `Bearer ${token}`)
            .send(o)
            .then(res => {
    ...
    resources.forEach(function(o, i){
      it('denies update exists weight resource', function(done) {
          o['value'] = 10;
          request
            .patch(`/api/v1/weight/${createdIds[i]}`)
            .set('Authorization', `Bearer ${token}`)
            .send(o)
            .end((err, res) => {
              res.should.have.status(400);
    ...
    resources.forEach(function(o, i){
      it('updates value weight resource', function(done) {
    ...
    resources.forEach(function(o, i){
      it('checks updated value weight resource', function(done) {
          request
            .get(`/api/v1/weight/${createdIds[i]}`)
            .set('Authorization', `Bearer ${token}`)
            .send(o)
    ...
    resources.forEach(function(o, i) {
      it('deletes created weight resource', function(done) {
          request
            .delete(`/api/v1/weight/${createdIds[i]}`)
            .set('Authorization', `Bearer ${token}`)
            .send(o)
            .then(res => {
              res.should.have.status(202);
    ...
    createdIds.forEach(function(id) {
      it('fail to delete created weight resource', function(done) {
          request
