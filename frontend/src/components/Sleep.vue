      ...
      <v-card>
        ...
        <v-container grid-list-sm class="pa-4">
          <v-layout row wrap>
            ...
            <v-flex xs12>
              <v-slider label="Minutes" color="primary" v-model="minutes" thumb-label ticks max="1440"></v-slider>
            </v-flex>

           </v-flex>
           <v-flex xs12>
              <v-slider label="Quality" color="primary" v-model="quality" thumb-label ticks max="10"></v-slider>
            </v-flex>
           </v-flex>
        ...
        <v-card-actions>
          ...
          <v-btn flat @click="saveSleep">Save</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
 ...
 export default {
  ...
  methods: {
    ...
    saveSleep: function() {
      ...
      // alert(this.minutes);
      this.dialog = false;
      if (this.date && this.minutes) {
        Rest.routes.sleep.create({data:{
          ...
          if(res.status == 201) {
            ...
            //     subtitle: `You slept ${this.minutes} minutes`,
            // })
            this.updateSleep();
      ...
      Rest.routes.sleep.list({query:{
        ...
        data = data.map((item) => {
          ...
          return {
            ...
            subtitle: `You slept ${item.value} minutes`,
          }
        });
        console.log(data);
